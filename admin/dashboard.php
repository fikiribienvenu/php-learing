...
<head>
    ...
    <title>Miltary CCS || Dashboard</title>
...
<li>
    <a href="#"><i class='bx bxs-user-badge icon'></i>Commander<i class='bx bx-chevron-right icon-right' ></i></a>
...
<li><a href="#"><i class='bx bx-line-chart icon' ></i>Charts</a></li>
<li><a href="#"><i class='bx bxs-widget icon' ></i>widgets</a></li>
<li class="divider" data-text="table and forms">Tables & forms</li>
<li><a href="#"><i class='bx bx-table icon'></i>Tables</a></li>
<li>
    <a href="#"><i class='bx bx-notepad icon'></i>Form<i class='bx bx-chevron-right icon-right' ></i></a>
    <ul class="side-dropdown">
        <li><a href="#">Basic</a></li>
        <li><a href="#">Selsect</a></li>
